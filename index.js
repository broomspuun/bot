...
const btn_tlk = [Markup.button.callback('Пообщаться со студентами👁️👄👁️', 'btn_talk')]
const btn_jna = [Markup.button.callback('Женя👨‍🎓','btn_jna')]
const btn_yna = [Markup.button.callback('Яна👩‍🎓','btn_yna')]

const menu = [
    [{text:'Победы ЯрГУ🏆',callback_data:'btn_win'},
    {text: 'Подать документы📂',callback_data:'btn_doc'}],
    [{text:'Наука📚',callback_data:'btn_sci'},
    {text: 'Факультеты🏛',callback_data:'btn_fac'}],
    [{text:'Сложность учёбы🚧',callback_data:'btn_hrd'},
    {text: 'Для иногородних🚴🏻',callback_data:'btn_aln'}],
    [{text:'Студенческая жизнь👨‍🎓',callback_data:'btn_slf'},
    {text: 'Моё хобби в ЯрГУ🏀',callback_data:'btn_hby'}],  
    [{text:'Расскажи мне что-то про ВУЗ📋',callback_data:'btn_abt'},
    {text: 'Стипендии💰',callback_data:'btn_stp'}],
    [{text: 'Главное меню🔎',callback_data:'back'}],
    [{text:'Пообщаться со студентами👁️👄👁️',callback_data:'btn_tlk'}]  
]
...
addAction('btn_tlk',`Ты всегда можешь пообщаться и уточнить что-то у наших студентов!`,[btn_yna,btn_jna,back])
addAction('btn_yna',`Привет, меня зовут Яна. Я настоящая студентка в ЯрГУ. Учусь на психолога, в магистратуре на первом курсе. Регулярно езжу на конференции и публикую статьи. Очень люблю мероприятия от ТочкиКипения, особенно, связанные с английским языком. Очень нравится ходить на настольный теннис. Люблю свой ВУЗ, поэтому пиши мне в телеграм и я расскажу тебе о нём больше.

@ElizavetaElagina`,[ [Markup.button.callback(`⏪⏪⏪`, 'btn_tlk')],
back])
addAction('btn_jna',`Привет, я Женя. В этом году выпускаюсь с ИВТ. Меня не очень привлекает написание статей и обсуждения за круглыми столами, поэтому я более активен во внеучебной деятельности. Два года назад вошёл в состав КВН, мне нравится атмосфера в команде. Часто хожу на Хакатоны. В прошлом году прошёл Школу проектного управления, узнал много полезного про проекты. Мне хочется, чтобы абитуриенты больше знали о ЯрГУ, но обычно, на дне открытых дверей рассказывают о направлениях и баллах, и никто не даёт в руки микрофон самим студентам, чтобы рассказать про жизнь. Ты можешь напрямую написать мне, и я расскажу от первого лица.

@kox3ik `,[ [Markup.button.callback(`⏪⏪⏪`, 'btn_tlk')],
back])
